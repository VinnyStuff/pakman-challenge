      ...
      <div className={styles.formContainer}>
        ...
        <div className={styles.inputContainer}>
          <div className={styles.inputs}>
            ...
            <TextField size="small" variant="outlined" fullWidth id="dataDeNascimento"/>
          </div>
        </div>
        ...
        <div className={styles.inputContainer}>
          <div className={styles.inputs}>
            ...
            <TextField size="small" variant="outlined" fullWidth id="cpf"/>
          </div>
          <div className={styles.inputs}>
            <Typography variant='subtitle1'>Renda Mensal</Typography>
            <TextField size="small" variant="outlined" fullWidth id="rendaMensal"/>
          </div>
        </div>
      </div>
      <div className={styles.buttonsContainer}>
        <Button variant="outlined" startIcon={<ArrowBackIcon/>} sx={{mx: '5px'}} onClick={handleBackButtonPressed}>Voltar</Button>
        <Button variant="contained" endIcon={<SaveAltIcon/>} sx={{mx: '5px'}} onClick={handleNextButtonPressed}>Salvar</Button>
      </div>
    </>
  );
}
